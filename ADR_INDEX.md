...
- [eSIM Auto Top-up v2 — Design Lock](./docs/design/esim-auto-topup-v2-design-lock.md) — **Accepted** (multi-condition OR triggers; supersedes v1 trigger shape only; does **not** amend ADR 010)
