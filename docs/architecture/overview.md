...
- [eSIM Auto Top-up v1 — Design Lock](../design/esim-auto-topup-v1-design-lock.md) (Accepted / shipped; does not amend ADR 010)
- [eSIM Auto Top-up v2 — Design Lock](../design/esim-auto-topup-v2-design-lock.md) (Accepted / shipped on staging; OR triggers; supersedes v1 trigger shape only; does not amend ADR 010)
