...
| Related | [ADR 016](../adr/016-web-design-tokens.md), [status.md](./status.md), [cap3-implementation-plan.md](./cap3-implementation-plan.md), Cap2 Review (`roamkit-web/components/ui/CAP2_REVIEW.md`) |
...
- [ ] Implementation Plan **Accepted** ([cap3-implementation-plan.md](./cap3-implementation-plan.md))
...
**Do not edit locked decisions above.** Next: Implementation Plan acceptance, then Cap3.1.
